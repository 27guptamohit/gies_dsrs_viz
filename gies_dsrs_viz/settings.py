"""
Django settings for gies_dsrs_viz project.
...
SECRET_KEY = '#=a9&*jwlz&5%#9j48+i41cm3qo=q@5anu=bz8xe=8guu7l_=!'
...
ROOT_URLCONF = 'gies_dsrs_viz.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'dsrs_viz/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'gies_dsrs_viz.wsgi.application'
...
STATIC_URL = '/static/'
# The below additional function says that,
# When the website will be uploaded on the https server,
